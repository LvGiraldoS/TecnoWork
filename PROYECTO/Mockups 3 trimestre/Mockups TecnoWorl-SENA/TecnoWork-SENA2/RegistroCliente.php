  ...
  <tr>
    <td  class="FondoAzul" ><form id="form1" name="form1" method="post" action="">
      <table width="539" border="0" align="center"  bordercolor="#02727D">
        ...
        <tr>
            <td height="45" align="left" valign="middle" class="fuenteRegistro2"><input type="submit" name="registrarC" id="enviar" value="Registrar" /></td>
            <td align="left" valign="middle" class="fuenteRegistro2">&nbsp;</td>
